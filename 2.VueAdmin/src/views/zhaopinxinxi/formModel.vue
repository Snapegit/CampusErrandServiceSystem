				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="工资" prop="gongzi">
							<el-input class="list_inp" v-model.number="form.gongzi" placeholder="工资"
								 type="number" 								:readonly="!isAdd||disabledForm.gongzi?true:false" />
						</el-form-item>
					</el-col>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.gangweixiangqing = res.data.data.gangweixiangqing?(res.data.data.gangweixiangqing.replace(reg,'../../../cl02737305/file')):'';
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='gongzi'){
					form.value.gongzi = row[x];
					disabledForm.value.gongzi = true;
					continue;
				}
				if(x=='zhaopinrenshu'){
