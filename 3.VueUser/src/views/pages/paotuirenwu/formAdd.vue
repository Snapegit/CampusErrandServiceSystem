			...
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="物品分类" prop="wupinfenlei">
						<el-select
							class="list_sel"
							:disabled="!isAdd||disabledForm.wupinfenlei?true:false"
							v-model="form.wupinfenlei" 
							placeholder="请选择物品分类"
							style="width:100%;"
							>
							<el-option v-for="(item,index) in wupinfenleiLists" :label="item"
								:value="item"
								>
							</el-option>
						</el-select>
				...
				<el-col :span="24">
					<el-form-item label="任务描述" prop="renwumiaoshu">
						<el-input class="list_inp" v-model="form.renwumiaoshu" placeholder="任务描述"
							 type="text" 							:readonly="!isAdd||disabledForm.renwumiaoshu?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="24">
					<el-form-item label="任务编号" prop="renwubianhao">
						<el-input class="list_inp" v-model="form.renwubianhao" placeholder="请输入任务编号" readonly></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="24">
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='renwumiaoshu'){
					form.value.renwumiaoshu = row[x];
					disabledForm.value.renwumiaoshu = true;
					continue;
				}
				if(x=='quhuodidian'){
				...
				if(x=='renwubianhao'){
					form.value.renwubianhao = row[x];
					disabledForm.value.renwubianhao = true;
					continue;
				}
			}
			if(row){
		...
		context?.$http({
			url: `option/wupinfenlei/fenlei`,
			method: 'get'
		}).then(res=>{
			wupinfenleiLists.value = res.data.data
		})
		zhuangtaiLists.value = "已接单,待接单".split(',')
	}
	//初始化
	//取消
	const backClick = () => {
