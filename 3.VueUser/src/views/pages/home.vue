	...
	<div>
		<div class="home_box">
			...
			<div class="homeList_view">
				<div class="homeList_title">跑腿任务展示</div>
				<div class="home_list_five">
					<div v-for="(item,index) in paotuirenwuHomeList" :class="'home_list_five_item' + (Number(index) + 1)" @click="detailClick('paotuirenwu',item.id)">
						<div class="img_box">
				...
				<div class="homeList_more_view" @click="moreClick('paotuirenwu')">
			...
			<div class="homeList_view">
				...
				<div class="home_list_five">
					<div v-for="(item,index) in zhaopinxinxiHomeList" :class="'home_list_five_item' + (Number(index) + 1)" @click="detailClick('zhaopinxinxi',item.id)">
						<div class="img_box">
							<img class="home_img" v-if="isHttp(item.tupian)" :src="item.tupian.split(',')[0]" alt="">
							<img class="home_img" v-else :src="item.tupian?$config.url + item.tupian.split(',')[0]:''" alt="">
						</div>
...
<script setup>
	...
	//跑腿任务首页展示
	const paotuirenwuHomeList = ref([])
	const getpaotuirenwuHomeList = () => {
		context?.$http({
			url: 'paotuirenwu/list',
			method: 'get',
			params: {
				page: 1,
				limit: 6
			...
			paotuirenwuHomeList.value = res.data.data.list
		})
	}
	//招聘信息首页展示
