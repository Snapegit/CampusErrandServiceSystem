	...
	<div class="app-contain" :style='{"padding":"20px 0px","margin":"20px auto 40px","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","width":"1200px","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth(tableName,'评价')" @click="dingdanpingjiaonAcross('评价','dingdanpingjia','','[1]','已评价')" type="warning">评价</el-button>
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('dingdanwancheng','支付')" class="approval_btn" @click="payClick">支付</el-button>
...
<script setup>
	...
	const dingdanpingjiaonAcross = (btnType,table,crossOptAudit,statusColumnName,tips,statusColumnValue) => {
