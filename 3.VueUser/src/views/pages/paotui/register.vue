	...
	<div>
		<div class="register_view">
			...
			<el-form :model="registerForm" class="register_form">
				<div class="list_item">
					<div class="list_label">跑腿账号：</div>
					<input class="list_inp"
					 v-model="registerForm.paotuizhanghao" 
					 placeholder="请输入跑腿账号"
					 type="text"
					 />
				</div>
				...
				<div class="list_item">
					<div class="list_label">跑腿姓名：</div>
					<input class="list_inp"
					 v-model="registerForm.paotuixingming" 
					 placeholder="请输入跑腿姓名"
					 type="text"
					 />
				</div>
				...
				<div class="list_item">
					<div class="list_label">跑腿手机：</div>
					<input class="list_inp"
					 v-model="registerForm.paotuishouji" 
					 placeholder="请输入跑腿手机"
					 type="text"
					 />
				</div>
...
<script setup>
	...
	const handleRegister = () => {
		...
		if((!registerForm.value.paotuizhanghao)){
		...
		if((!registerForm.value.paotuixingming)){
		...
		if((!registerForm.value.paotuishouji)){
			context?.$toolUtil.message(`跑腿手机不能为空`,'error')
			return false
		}
		if(registerForm.value.paotuishouji&&(!context?.$toolUtil.isMobile(registerForm.value.paotuishouji))){
...
<style lang="scss" scoped>
	.register_view {
		...
		background: url(http://clfile.zggen.cn/20240423/ae32b969722941739acad61984670d8a.jpg);
		display: flex;
