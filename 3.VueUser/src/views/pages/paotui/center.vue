		...
		<div class="usersView">
			...
			<div class="usersBox" v-if="tabIndex=='center'">
				<el-form class="usersForm" ref="userFormRef" :model="userForm" label-width="120px" :rules="rules">
					<el-row>
						<el-col :span="24">
							<el-form-item prop="paotuizhanghao" label="跑腿账号">
								<el-input class="list_inp" v-model="userForm.paotuizhanghao" placeholder="跑腿账号" readonly></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
						...
						<el-col :span="24">
							<el-form-item prop="paotuixingming" label="跑腿姓名">
								<el-input class="list_inp" v-model="userForm.paotuixingming" placeholder="跑腿姓名" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
						...
						<el-col :span="24">
							<el-form-item prop="paotuishouji" label="跑腿手机">
								<el-input class="list_inp" v-model="userForm.paotuishouji" placeholder="跑腿手机" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
...
<script setup>
	...
	const getSession = () =>{
		context?.$http({
			...
			context?.$toolUtil.storageSet("frontName", res.data.data.paotuizhanghao)
