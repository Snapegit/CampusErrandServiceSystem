			...
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="用户地址" prop="yonghudizhi">
						<el-input class="list_inp" v-model="form.yonghudizhi" placeholder="用户地址"
							 type="text" 							:readonly="!isAdd||disabledForm.yonghudizhi?true:false" />
					</el-form-item>
				</el-col>
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='yonghudizhi'){
					form.value.yonghudizhi = row[x];
					disabledForm.value.yonghudizhi = true;
					continue;
				}
				if(x=='touxiang'){
